...
# AREA constraint
area = Function("area","GEOMETRY/of_func.csv",LabeledTableReader('"AIRFOIL_AREA"'))
...
# TOC constraint
toc = Function("toc","GEOMETRY/of_func.csv",LabeledTableReader('"AIRFOIL_TOC"'))
toc.addInputVariable(ffd,"GEOMETRY/of_grad.csv",LabeledTableReader('"AIRFOIL_TOC"',',',(0,None)))
toc.addValueEvalStep(deform)
toc.addValueEvalStep(geometry)
toc.setDefaultValue(0.0)
...
# Moment constraint
driver.addUpperBound(mom, 0.093, 1)

#driver.addLowerBound(mom, 0.09199, GlobalScale)

# Area constraint
driver.addLowerBound(area, 0.0779644, 1)

# TOC constraint
driver.addLowerBound(toc, 0.0001, 1)
